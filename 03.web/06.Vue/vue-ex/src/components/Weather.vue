<template>
  <div>
    ...
    <span class="mx-3"><i class="fas fa-temperature-low"></i> : {{ weather_main.temp }} °C</span>
    <span class="mx-3"><i class="fas fa-tint"></i> : {{ weather_main.humidity }} %</span>
    <span class="mx-3"><i class="fas fa-wind"></i> : {{ wind.speed }} m/s</span>
    <span class="mx-3"><i class="fas fa-location-arrow"></i> : {{ wind.deg }} °</span>
  </div>
</template>
